...
`);
    ...
    function Ed({ callsite: e, message: r, originalMethod: t, isPanic: n, callArguments: i }, o) {
      ...
      if (!e || typeof window < "u" || true) return s;
      let a = e.getLocation();
...
var require_client = __commonJS({
  "node_modules/.prisma/client/index.js"(exports2) {
    ...
    exports2.Prisma.StationScalarFieldEnum = {
      id: "id",
      brand: "brand",
      address: "address",
      postcode: "postcode",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/domhoney/Documents/Cursor/pump-prices/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/domhoney/Documents/Cursor/pump-prices/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
model PriceHistory {
  ...
  stationId String
  fuelType  String // e.g., 'E10', 'B7', 'unleaded', 'diesel'
  price     Float
  timestamp DateTime // when the price was last updated according to the API

  station Station @relation(fields: [stationId], references: [id], onDelete: Cascade)

  @@unique([stationId, fuelType, timestamp])
  @@index([stationId])
  @@index([fuelType])
  @@index([timestamp])
...
async function bulkUpsertStations(stations) {
  for (const stationChunk of chunkArray(stations, STATION_UPSERT_CHUNK_SIZE)) {
    await prisma.$executeRaw`
      ...
      stationChunk.map(
        (station) => import_client2.Prisma.sql`(${station.id}, ${station.brand}, ${station.address}, ${station.postcode}, ${station.lat}, ${station.lng}, NOW(), NOW())`
      )
    )}
